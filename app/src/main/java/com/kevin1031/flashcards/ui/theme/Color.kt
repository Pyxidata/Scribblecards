...
package com.kevin1031.flashcards.ui.theme

import androidx.compose.ui.graphics.Color

val md_theme_light_primary = Color(0xFFF193A1) // top toolbar, appbar, important buttons, etc.
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFF193A1) // selected decks, action button, etc.
val md_theme_light_onPrimaryContainer = Color(0xFFFFFFFF)
val md_theme_light_secondary = Color(0xFF422C31) // dark color used for exceptions
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFF5F0F1) // dialogs, decks, etc.
val md_theme_light_onSecondaryContainer = Color(0xFF422C31)
val md_theme_light_tertiary = Color(0xFFFF9320) // favorite star
val md_theme_light_onTertiary = Color(0xFF422C31) // selected bundles
val md_theme_light_tertiaryContainer = Color(0xFFA2888B) // bundles, etc.
...
val md_theme_light_onBackground = Color(0xFF422C31)
val md_theme_light_surface = Color(0xFFFEFBFF)
val md_theme_light_onSurface = Color(0xFF422C31) // text in textfield, etc.
val md_theme_light_surfaceVariant = Color(0xFFF5F0F1) // compose card default background
val md_theme_light_onSurfaceVariant = Color(0xFF422C31) // text in dialogs, etc.
val md_theme_light_outline = Color(0xFF767680)
val md_theme_light_inverseOnSurface = Color(0xFFF3F0F4)
val md_theme_light_inverseSurface = Color(0x80E77485) // open bundle background
val md_theme_light_inversePrimary = Color(0xFFF5F0F1)
val md_theme_light_surfaceTint = Color(0xFFF5F0F1)
val md_theme_light_outlineVariant = Color(0xFFF5F0F1)
val md_theme_light_scrim = Color(0xFF422C31)
